        ...
        <div className="row">
          <div className="col-lg-6 col-md-9 mt-5" >
            <div className="section-tittle section-tittle2 mb-50">
              ...
              <p>El Comité Científico de SEER está conformado por médicos especialistas en enfermedades de baja prevalencia y con una gran trayectoria en sus áreas.</p>
            </div>
          </div>
