...
function Convocatoria() {
  return (
    ...
    <>
      <section className='resultados bg-white pb-5' data-aos="fade-in" >
        <div className="contenedor p-4">
          ...
          <ul>
            <li><strong>Dr. Carlos Alberto Venegas Vega</strong></li>
            <li> <strong>Dra. Cristina Simón Gómez</strong></li>
            <li> <strong>Dra. Alicia Rivera Cameras</strong></li>
          </ul>
          <p>Aunado a esa emoción, les tenemos otra sorpresa</p>
          <p >Gracias a su esfuerzo y al de SEER tendremos un cuarto ganador:</p>
          <ul>
            <li><strong>Dra. Adriana Jonguitud Aguilar</strong></li>

          </ul>
          <p>En SEER estamos de fiesta y celebración, sabiendo que conforme vayamos avanzando en nuestras actividades y consolidándonos podremos llegar a más pacientes y apoyarles en todo lo que podamos.</p>
          <p> Estaremos en contacto con los ganadores para los siguientes pasos.</p>
          <p> Disfruten y compartan con sus pacientes.</p>
        </div>
      ...
      <section className="convocatoria bg-white" data-aos="fade-up">
        <div className="contenedor-convocatoria p-4 ">
          ...
          <h1 className='mt-5'>Convocatoria  <span className="badge badge-dark">Cerrada</span></h1>
