  ...
  return (
    <section className="contenedor contenedor-transmision">
      ...
      <div className="video-contenedor">
        ...
        <div style={{ padding: '56.25% 0 0 0', position: 'relative' }}><iframe title="seer día 2" src="https://vimeo.com/event/1860866/embed" frameBorder={0} allow="autoplay; fullscreen; picture-in-picture" allowFullScreen style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} /></div>
